...
from config import config  # Import du fichier config.py
import pickle  # Ajout pour la sérialisation
from pathlib import Path

class RecommendationSystem:
    def __init__(self, embedding_model_name, data, device=None, embeddings_path=None):
        """
    ...
    def preprocess_data(self):
        ...
        """
        combined_columns = config['combined_features_columns']
        self.data['combined_features'] = self.data[combined_columns].apply(
